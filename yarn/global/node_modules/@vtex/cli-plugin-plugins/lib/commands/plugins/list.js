...
PluginsIndex.flags = {
    core: command_1.flags.boolean({ description: "Shows core plugins." }),
};
PluginsIndex.description = "Lists all plugins installed on your machine.";
PluginsIndex.examples = [
    `${vtex_1.ColorifyConstants.COMMAND_OR_VTEX_REF("vtex plugins list")}`,
];
