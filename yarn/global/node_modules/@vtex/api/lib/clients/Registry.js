...
const routes = {
    ...
    AppQueryString: (basePath, appQueryString) => appQueryString ? `${basePath}?${appQueryString.name}=${appQueryString.value}` : basePath,
...
class Registry extends HttpClient_1.InfraClient {
    constructor(context, options) {
        ...
        this.validateApp = (app, version, appQueryString) => {
